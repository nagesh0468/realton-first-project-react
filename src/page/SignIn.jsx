      ...
      <div className=" flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl m-auto " >
        ...
        <div className=" w-full md:w-[67%] lg:w-[40%] lg-ml-20 ml-8 " >
          ...
          <div className=" flex justify-between whitespace-nowrap text-sm sm:text-lg my-5" >
            <p> Don't have a account? <Link to="/signup" className=" text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-2 " > Registor </Link></p>
          ...
          <button className=" w-full bg-blue-600 text-white px-7 py-3 text-5m font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800  " type="submit" > sign in </button>
